...
$(document).ready(function() {
	...
	init_spinner('distortion_k1', 0.1, 0.0);
	init_spinner('distortion_k2', 0.1, 0.0);
	init_spinner('distortion_k3', 0.1, 0.0);
	...
	init_spinner('pos_x_m', 0.1, 0);
	init_spinner('pos_y_m', 0.1, 0);
	init_spinner('tilt_deg', 0.5, 0);
	init_spinner('heading_deg', 0.5, 0);
	init_spinner('roll_deg', 0.5, 0);
